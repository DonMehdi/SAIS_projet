...
if(strlen ($ID) != 10 || !is_numeric($ID) || $ID == NULL || $ID <=0 || $ID >= 1999999999)
    {
        echo '<meta HTTP-EQUIV="REFRESH" content="3; url=Add-Member.php">';
        echo "<center><font face='Verdana' size='3' color=red>
        The member ID should be a number and exactly 10 digits length!!!
        <br> <br> <br>
        Wait!!! You will be redirected in 3 seconds ...</font></center>";
        exit ();
        $status= "NOTOK";
...
if($First_Name == NULL || $Last_Name == NULL)
    {
        echo '<meta HTTP-EQUIV="REFRESH" content="3; url=Add-Member.php">';
        echo "<center><font face='Verdana' size='3' color=red>
        Please write the member first name and last name!!!
        <br> <br> <br>
        Wait!!! You will be redirected in 3 seconds ...</font></center>";
        exit ();
        $status= "NOTOK";
...
if($Contact == NULL || $Address == NULL)
    {
        echo '<meta HTTP-EQUIV="REFRESH" content="3; url=Add-Member.php">';
        echo "<center><font face='Verdana' size='3' color=red>
        Please write the contact number and the address of the member!!!
        <br> <br> <br>
        Wait!!! You will be redirected in 3 seconds ...</font></center>";
        exit ();
        $status= "NOTOK";
...
if($status=="OK")
    ...
    $sql= "INSERT INTO $tbl_name (User_ID,User_Password,User_Type,User_First_Name,User_Last_Name,User_Address,User_Contact,User_Email,User_Society_ID)
           VALUES ('$ID','$password','$user_type','$First_Name','$Last_Name','$Address','$Contact','$Email','$societyid')";
        ...
        echo "<center><font face='Verdana' size='3' color=red>
        The new member has been added to the database!!!
        <br> <br> <br>
